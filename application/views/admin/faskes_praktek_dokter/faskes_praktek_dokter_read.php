...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Tb_faskes_praktek_dokter Read</h2>
        <table class="table">
	    ...
	    <tr><td>id_dokter</td><td><?php echo $id_dokter; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('faskes_praktek_dokter') ?>" class="btn btn-default">Cancel</button></td></tr>
	</table>
    </body>
</html>